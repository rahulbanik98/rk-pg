        ...
        <div className={styles.inner}>
          <div className={styles.brand}>
            ...
            <div className={styles.socials}>
              ...
              <a href="https://wa.me/919876543210" className={styles.social} target="_blank" rel="noreferrer" aria-label="WhatsApp">💬</a>
            </div>
          </div>
          ...
          <div className={styles.col}>
            ...
            <ul>
              ...
              <li><a href="https://maps.app.goo.gl/8mT9R9Mi9ik9g8vU7" target="_blank" rel="noreferrer">📍 Get Directions</a></li>
            </ul>
          </div>
        </div>

        <div className={styles.bottom}>
          <p>© 2025 RK PG Hostel, Pune. All rights reserved.</p>
