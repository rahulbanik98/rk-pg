...
var getAnalyticsOptions = function (options, features) {
    ...
    return options ? {
        trackedAnalytics: __assign$1(__assign$1({ sdkCode: options.sdkCode, sdkSemver: options.sdkSemver, techVersion: options.techVersion }, (options.product !== undefined && { product: options.product })), features)
    } : null;
};
...
var SDKAnalyticsConstants = __assign({ sdkSemver: '1.14.4', techVersion: React__default["default"].version, sdkCode: isCLIDetected ? 'H' : 'J' }, (isCLIDetected && { product: 'B' }));
