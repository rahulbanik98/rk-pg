(function (global, factory) {
	...
	***************************************************************************** */
	...
	var getAnalyticsOptions = function (options, features) {
	    ...
	    return options ? {
	        trackedAnalytics: __assign(__assign({ sdkCode: options.sdkCode, sdkSemver: options.sdkSemver, techVersion: options.techVersion }, (options.product !== undefined && { product: options.product })), features)
	    } : null;
	};
